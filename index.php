...
<body>
    <a href="#janela1" rel="modal">Inserir usuário</a>
    <br>
    <a href="#janela2" rel="modal">Excluir usuário</a>
    ...
    <div id="table">
        ...
        <div class="window" id="janela2">
            ...
            <form id="deleUsuario" action="" method="POST">
                <label>Senha:</label><input type="text" name="senha" id="senha" />
                <br /><br />
...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        ...
        $('#excluir').click(function() {
            ...
            var dados = $('#deleUsuario').serialize();
